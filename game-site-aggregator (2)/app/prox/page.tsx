...
const proxies = [
  ...
  },
  {
    ...
    description: "Quasar main proxy endpoint",
  },
  {
    name: "Quasar - LearnSK Tech",
    url: "https://learnskquasar-tech.infotechnology.com/",
    description: "Alternate Quasar learning-focused endpoint",
  },
  {
    name: "Quasar - Watching",
    url: "https://watching.national-birdshow.com/",
    description: "Media-focused Quasar mirror",
  },
  {
    name: "Jordans Math",
    url: "http://studentgovernment.servehttp.com/",
    description: "Math-themed proxy instance",
  },
  {
    name: "Overcloaked",
    url: "https://watch.national-birdshow.com/",
    description: "Cloaked media proxy mirror",
  },
  {
    name: "Galaxy",
    url: "https://galaxy.sk.tech.infotechnology.com/onboarding/",
    description: "Galaxy proxy onboarding endpoint",
  },
  {
    name: "Shadow - Novalogic",
    url: "https://novalogic.tejidosdedignidad.org/",
    description: "Shadow proxy mirror (Novalogic)",
  },
  {
    name: "Rammerhead",
    url: "https://rammerheaddnssucks.infotechnology.com/",
    description: "Rammerhead-based proxy instance",
  },
];
